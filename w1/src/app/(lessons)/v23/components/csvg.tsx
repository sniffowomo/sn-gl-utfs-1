export default function Circ() {
  return (
    <section className="grid">
      ...
      <h1 className="text-2xl text-center bg-teal-500">
        Circle 4
        <code className="bg-yellow-300 text-black tracking-widest">Bounce</code>
      </h1>
      <div className="flex flex-col p-3 items-center justify-center  bg-slate-900">
        <svg
          className="w-48 animate-bounce text-white"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24">
          <circle
      ...
      <div className="flex flex-col p-3 items-center justify-center  bg-slate-900">
        <svg
          className="w-48 animate-spin-slow text-white"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24">
          <circle
